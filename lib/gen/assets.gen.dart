...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/iconLeft.png
  AssetGenImage get iconLeft =>
      const AssetGenImage('assets/images/iconLeft.png');
  ...
  /// File path: assets/images/yolotext.png
  AssetGenImage get yolotext =>
      const AssetGenImage('assets/images/yolotext.png');

  /// List of all assets
  List<AssetGenImage> get values =>
      [bgImage, iconLeft, logo, placeholderImage, rectangle, yolotext];
}
